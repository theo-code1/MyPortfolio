...
const AboutSection = ({ aboutRef }) => {
  return (
    <section
      ref={aboutRef}
      id="about"
      className="max-w-screen font-switzer flex items-center justify-between pl-48 pr-40 pt-24 pb-32 overflow-x-hidden "
    >
        ...
        >
          <ul className="space-y-2 text-lg text-black/75 font-medium mb-8">
            <li className={`flex items-center gap-3`}>
              <CheckCircle className="text-2xl text-primary-blue" />
