    ...
    <section id="Overview" ref={overviewRef} className='h-max pt-10 md:pt-18 lg:pt-24 pb-12 px-2 max-w-screen overflow-x-hidden'>
        ...
        <div className="cta-content flex flex-col gap-6 text-center w-fit mx-auto mt-24">
            ...
            <div className="hero-headline-motion flex flex-col items-center justify-center text-center mx-auto">
              ...
              <h3 className='text-sm md:text-xl font-switzer text-dark-blue mb-8 animate-none md:animate-poop [--delay:0.5] md:[--delay:1.2]'  >Never miss a note, an idea, or a connection again—stay organized, inspired,<br className="hidden md:flex" /> and effortlessly connected every step of the way.</h3>
              <div className="cta-buttons flex items-center gap-3 md:gap-6 mx-auto animate-none md:animate-position-opacity">
                  ...
                  <Link to={'/contact'} className='flex items-center gap-2 px-4 md:px-8 py-3 md:py-4 bg-primary-blue text-white rounded-xl font-switzer font-medium text-lg hover:brightness-95 active:brightness-80 transition-all duration-200 cursor-pointer group' >Start Your Project <GoArrow className='text-2xl group-hover:translate-x-2 group-hover:-translate-y-1 group-hover:scale-[1.1] transition-all duration-200'/></Link>
              </div>
