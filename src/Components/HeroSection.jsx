    ...
    <section id="Overview" ref={overviewRef} className='h-max pt-10 md:pt-20 lg:pt-24 pb-12 px-2 max-w-screen overflow-x-hidden'>
        ...
        <div className="cta-content flex flex-col gap-6 text-center w-fit mx-auto mt-24">
            ...
            <div className="hero-headline-motion flex flex-col items-center justify-center text-center mx-auto">
              ...
              <div className="cta-buttons flex items-center gap-3 md:gap-6 mx-auto md:animate-position-opacity">
              ...
              <div className="trust flex gap-4 items-center mx-auto animate-blur mb-8 md:mb-16 lg:mb-24">
